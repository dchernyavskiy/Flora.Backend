    ...
    public static WebApplicationBuilder AddInfrastructure(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddCustomAuthorization(
            rolePolicies: new List<RolePolicy>
                          {
                              new(OrderConstants.Role.Admin, new List<string> {OrderConstants.Role.Admin}),
                              new(OrderConstants.Role.User, new List<string> {OrderConstants.Role.User})
                          });
        ...
        builder.Configuration.AddEnvironmentVariables("flora_catalogs_env_");

        builder.AddCustomVersioning();

        builder.AddCustomSwagger(typeof(OrderAssemblyInfo).Assembly);
