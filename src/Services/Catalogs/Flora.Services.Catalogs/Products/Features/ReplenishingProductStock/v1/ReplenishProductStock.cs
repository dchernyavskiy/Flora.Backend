...
namespace Flora.Services.Catalogs.Products.Features.ReplenishingProductStock.v1;

public record ReplenishProductStock(Guid ProductId, int Quantity) : ITxCommand;
