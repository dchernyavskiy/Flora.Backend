...
public static class MassTransitExtensions
{
    ...
    {
        cfg.Message<ProductCreatedV1>(e => e.SetEntityName($"{nameof(ProductCreatedV1).Underscore()}.input_exchange")); // name of the primary exchange
        ...
        cfg.Message<ProductStockDebitedV1>(
            e => e.SetEntityName($"{nameof(ProductStockDebitedV1).Underscore()}.input_exchange")
        ...
        cfg.Message<ProductStockReplenishedV1>(
            e => e.SetEntityName($"{nameof(ProductStockReplenishedV1).Underscore()}.input_exchange")
        ); // name of the primary exchange
