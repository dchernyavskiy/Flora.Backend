using Flora.Services.Shared.Identity.Users.Events.v1.Integration;
using Flora.Services.Identity.Users.Features.UpdatingUserState.v1.Events.Integration;
using Humanizer;
using MassTransit;
...
internal static class MassTransitExtensions
{
    ...
    {
        cfg.Message<UserRegisteredV1>(e => e.SetEntityName($"{nameof(UserRegisteredV1).Underscore()}.input_exchange")); // name of the primary exchange
        ...
        cfg.Message<UserStateUpdated>(e => e.SetEntityName($"{nameof(UserStateUpdated).Underscore()}.input_exchange")); // name of the primary exchange
