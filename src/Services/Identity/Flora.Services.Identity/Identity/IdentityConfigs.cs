...
using Flora.Services.Identity.Identity.Features.GettingClaims.v1;
using Flora.Services.Identity.Identity.Features.Login.v1;
using Flora.Services.Identity.Identity.Features.Logout.v1;
using Flora.Services.Identity.Identity.Features.RefreshingToken.v1;
using Flora.Services.Identity.Identity.Features.RevokingAccessToken.v1;
using Flora.Services.Identity.Identity.Features.RevokingRefreshToken.v1;
using Flora.Services.Identity.Identity.Features.SendingEmailVerificationCode.v1;
using Flora.Services.Identity.Identity.Features.VerifyingEmail.v1;
using Flora.Services.Identity.Shared.Extensions.WebApplicationBuilderExtensions;
using Flora.Services.Identity.Identity.Data;
using Flora.Services.Identity.Shared;
using Microsoft.AspNetCore.Authentication.JwtBearer;

namespace Flora.Services.Identity.Identity;
